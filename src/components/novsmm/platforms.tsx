...
export const PLATFORMS: Platform[] = [
  { name: "Instagram", Icon: InstagramMark, tint: "#E1306C", services: 48, blurb: "Followers, likes, views, reels, stories." },
  { name: "TikTok", Icon: TikTokMark, tint: "#111111", services: 36, blurb: "Views, likes, followers, shares, saves." },
  { name: "YouTube", Icon: YouTubeMark, tint: "#FF0000", services: 29, blurb: "Watch hours, subs, likes, shorts." },
  { name: "Facebook", Icon: FacebookMark, tint: "#1877F2", services: 31, blurb: "Page likes, reach, group members." },
  { name: "X", Icon: XMark, tint: "#111111", services: 22, blurb: "Followers, impressions, retweets." },
  { name: "Telegram", Icon: TelegramMark, tint: "#229ED9", services: 18, blurb: "Members, views, reactions, bots." },
  { name: "Discord", Icon: DiscordMark, tint: "#5865F2", services: 14, blurb: "Members, online boost, reactions." },
  { name: "Spotify", Icon: SpotifyMark, tint: "#1DB954", services: 12, blurb: "Plays, listeners, followers, saves." },
  { name: "Twitch", Icon: TwitchMark, tint: "#9146FF", services: 16, blurb: "Viewers, followers, clip views." },
  { name: "Threads", Icon: ThreadsMark, tint: "#111111", services: 9, blurb: "Followers, likes, reposts." },
  { name: "Kick", Icon: KickMark, tint: "#53FC18", services: 7, blurb: "Followers, live viewers, chat." },
];
