...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "Access to 263 services",
      "5 connected platforms",
      "Stripe + PayPal payouts",
      "Standard order start (~2s)",
  ...
  },
  {
    ...
    features: [
      ...
      "All 12+ payment gateways",
      "Priority order start (<1.2s)",
      "Crypto settlement · 0% fee",
  ...
  },
  {
    ...
    features: [
      "Unlimited orders",
      "Dedicated infrastructure & IP pool",
      "Custom SLA · 99.99% uptime",
      "SSO · SCIM · audit logs export",
      "Private provider integrations",
      "Dedicated success engineer",
      "Custom currency hedging",
      "99.99% uptime credit backing",
    ],
  },
];
