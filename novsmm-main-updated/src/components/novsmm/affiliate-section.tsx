...
export function AffiliateSection() {
  ...
  return (
    <section id="affiliates" className="nov-anchor-section relative py-4 sm:py-32">
      <div
        aria-hidden
              ...
              <div className="mt-6 border-t border-border/60 pt-5">
                ...
                <ul className="mt-3 flex flex-col gap-2">
                  {PAYOUT_METHODS.map((m) => (
                    <li
                      key={m.label}
                      className="flex flex-col gap-1 rounded-xl border border-border/60 bg-muted/20 px-4 py-2.5 sm:flex-row sm:items-center sm:justify-between"
                    >
            ...
            <div className="flex h-full flex-col rounded-3xl border border-border/60 bg-background p-6 nov-ring sm:p-8">
              ...
              <div className="mt-6 flex flex-col gap-4">
                {STEPS.map((s, i) => (
                  <div
                    key={s.titleKey}
                    className="fm-fade-up flex items-start gap-4 rounded-2xl border border-border/60 bg-muted/20 p-4 sm:items-start"
                    style={{
