...
export function Payments() {
  const { t } = useLanguage();
  return (
    <section id="payments" className="nov-anchor-section relative overflow-hidden py-4 sm:py-32">
      <div
        aria-hidden
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
            ...
            {PROVIDERS.map((p, i) => (
              <Reveal key={p.name} blur delay={i * 0.08}>
                <div className="group relative h-full overflow-hidden rounded-2xl border border-border/60 bg-background p-5 transition-shadow hover:nov-ring-lg">
                  ...
                  <div className="mt-4 grid grid-cols-1 gap-2 border-t border-border/60 pt-3 text-[11px] sm:grid-cols-3">
        ...
        {/* Footer stat strip */}
        <Reveal delay={0.1}>
          <div className="mt-10 grid grid-cols-1 gap-3 rounded-2xl border border-border/60 bg-muted/30 p-4 sm:grid-cols-2 sm:p-6 lg:grid-cols-4">
