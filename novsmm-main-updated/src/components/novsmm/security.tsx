...
export function Security() {
  const { t } = useLanguage();
  return (
    <section id="security" className="nov-anchor-section relative overflow-hidden py-4 sm:py-32">
      <div
        aria-hidden
  ...
  return (
    <div className="relative mx-auto aspect-square w-full max-w-[420px] overflow-hidden rounded-3xl border border-border/60 bg-background nov-ring">
      ...
      {[
        ...
        <div
          key={p.label}
          className="absolute hidden items-center gap-1.5 rounded-full border border-border/60 bg-background/90 px-2.5 py-1 text-[11px] font-medium text-foreground/80 backdrop-blur-md fm-fade-up sm:flex"
      ...
      {/* bottom metric strip */}
      <div className="absolute inset-x-4 bottom-4 grid grid-cols-1 gap-2 sm:grid-cols-3">
