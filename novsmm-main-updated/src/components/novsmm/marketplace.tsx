...
export function Marketplace() {
  ...
  return (
    <section id="marketplace" className="nov-anchor-section relative py-4 sm:py-32">
      {/* divider line */}
      <div
        aria-hidden
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 lg:grid-cols-2">
          {/* Flow diagram */}
          <Reveal blur>
            <div className="relative h-full overflow-hidden rounded-3xl border border-border bg-background p-6 sm:p-8 hover:border-foreground transition-colors">
              ...
              <div className="mt-7 flex flex-col gap-4">
                {FLOW.map((s, i) => (
                  <div key={s.title} className="relative">
                    <div
                      className="fm-slide-left flex items-start gap-3 rounded-2xl border border-border/60 bg-muted/30 p-3 sm:gap-4 sm:p-4"
                      style={{
                        animationDuration: "0.7s",
                        animationDelay: `${i * 0.12}s`,
                      }}
                    >
                      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-background text-foreground border border-border sm:h-10 sm:w-10">
          ...
          <Reveal blur delay={0.1}>
            <div className="flex h-full flex-col overflow-hidden rounded-3xl border border-border bg-background p-6 hover:border-foreground transition-colors sm:p-8">
              ...
              <div className="mt-5 flex flex-col gap-2">
                {offers.map((o, i) => (
                  <div
                    key={o.id ?? i}
                    className="fm-fade-up group flex flex-col gap-3 rounded-2xl border border-border/60 bg-background p-3 transition-colors hover:bg-muted/40 sm:flex-row sm:items-center"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex flex-row items-center justify-between gap-3 sm:ml-auto sm:flex-col sm:items-end sm:justify-start">
              ...
              {/* wallet strip */}
              <div className="mt-auto flex flex-col gap-3 rounded-2xl border border-border/60 bg-muted/30 p-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex items-center gap-3">
                  <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-background text-foreground border border-border">
                ...
                <button className="inline-flex items-center justify-center gap-1.5 rounded-full bg-foreground px-4 py-2 text-xs font-medium text-background transition-colors hover:bg-muted hover:text-foreground border border-foreground">
