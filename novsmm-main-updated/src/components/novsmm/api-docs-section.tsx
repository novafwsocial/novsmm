...
function CodeBlock({
  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-border/60 bg-[#0a0d14] nov-ring">
      <div className="flex flex-col gap-2 border-b border-white/5 px-4 py-2.5 sm:flex-row sm:items-center sm:justify-between">
      ...
      <pre className="overflow-x-auto px-3 py-3 text-[11px] leading-relaxed sm:px-4 sm:py-4 sm:text-[12.5px]">
...
export function ApiDocsSection() {
  const { t } = useLanguage();
  return (
    <section id="api-docs" className="nov-anchor-section relative py-4 sm:py-32">
      <div
        aria-hidden
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <Reveal blur delay={0.08}>
            <div className="flex h-full flex-col rounded-3xl border border-border/60 bg-background p-5 nov-ring sm:p-8">
              ...
              <ul className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {FEATURES.map((f, i) => (
                  <li
                    key={f.titleKey}
                  className="group flex items-start gap-3 rounded-2xl border border-border/60 bg-muted/20 p-3 transition-colors hover:bg-muted/40 fm-fade-up sm:p-3.5"
              ...
              <div className="mt-6 flex flex-col gap-3 border-t border-border/60 pt-5 sm:flex-row sm:flex-wrap sm:items-center">
                <Magnetic
                  as="button"
                  strength={0.25}
